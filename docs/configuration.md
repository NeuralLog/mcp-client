...
This document describes the configuration options for NeuralLog @ai-mcp-logger/mcp-client.

## Configuration Options

The @ai-mcp-logger/mcp-client can be configured using the following options:
...
@ai-mcp-logger/mcp-client also supports configuration via environment variables:
...
You can also configure @ai-mcp-logger/mcp-client using a configuration file:
